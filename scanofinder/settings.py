"""
Django settings for scanofinder project.
"""
...
WSGI_APPLICATION = 'scanofinder.wsgi.application'
...
# Payfast / subscription (amount in cents — R200 = 20000)
